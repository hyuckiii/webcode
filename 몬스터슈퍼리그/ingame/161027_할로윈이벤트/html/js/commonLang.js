...
function commonLang (langType) {
  var langKo = {
    ...
    langJa = {
      ...
      fail: 'アイテムが正しく<br>配布されませんでした。<br><span>もう一度 [受け取る] ボタンをタップしてね。</span>',
      error: '正しくないアクセスです。<br><span>もう一度 [受け取る] ボタンをタップしてね。</span>',
      btnName: '確認'
    },
    langTh = {
      title: 'Monster Super League',
    ...
    langHant = {
      ...
      fail: '獎勵未正常發送,<br><span>請再試一次。</span>',
      error: '連線異常,<br><span>請再試一次。</span>',
      btnName: '確認'
    };
